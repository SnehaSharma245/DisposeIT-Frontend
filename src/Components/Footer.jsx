	...
	return (
		<div>
			<div className="h-fit w-full mt-[20vh] md:flex flex-col justify-center shadow-3xl  p-5">
				<div>
					<h1 className="font-semibold font-montserrat text-xl text-[#222222] text-left">
				...
				<div className="flex  items-center justify-center mt-5">
					<h1 className="flex justify-center text-xl text-left   font-montserrat font-semibold gap-2">
						Created by<span className="font-bold text-xl  font-montserrat text-[#ff5757]">DisposeIT</span>team
					</h1>
				</div>
			</div>
		</div>
