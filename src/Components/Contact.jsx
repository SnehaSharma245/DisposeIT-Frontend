	...
	return (
		<div id="contact">
			<div className="flex flex-col  justify-center items-center mt-[20vh]">
				<h1 className="mb-[10vh] font-montserrat font-bold text-2xl">Contact Us</h1>
				<div className="w-fit h-fit bg-[#343434] shadow-3xl rounded-xl  p-[5vh] md:ml-5 mb-10 z-10 searchtext card">
					<h1 className="md:text-[5vh] text-[8vh] font-montserrat  font-bold">Contact our Team</h1>
					...
					<div className="mt-10 flex flex-col gap-5">
						<div className="md:flex  md:gap-5">
							<div className="relative">
								...
								<input
									type="email"
									className="w-full mt-2 rounded-lg  p-4 font-montserrat border-2 font-medium bg-[#dfdede]"
									onChange={(e) => {
							...
							<div className="relative">
								...
								<input
									type="text"
									className="w-full mt-2 rounded-lg text-[#222222] p-4 font-montserrat border-2 font-medium bg-[#dfdede]"
									onChange={(e) => {
