	...
	return (
		<Wrapper>
			<div className=" flex flex-col  justify-center items-center mt-[20vh] relative" id="Education">
				<h1 className="mb-[10vh] font-montserrat font-bold text-2xl">How we Work</h1>
			...
			<div className="flex justify-center">
				<p className="mt-[10vh] md:w-[60vw] text-center font-montserrat font-semibold">
					We're the link between e-waste recycling companies and eco-conscious consumers. Our platform connects clients with trusted
					recycling partners, streamlining the recycling process and offering rewards for sustainable choices.
				</p>
			</div>
		</Wrapper>
	);
